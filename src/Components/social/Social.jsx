        ...
        <SocialContainer>
            <Row>
                <Col md={12}>
                    ...
                    <a href="https://drive.google.com/file/d/1bEaawl3DAva3zEGugk1WNifPq4ia5ZHw/view?usp=sharing" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon alt="CV" icon={faFileDownload} size="1x" color="#ed6c82" /></a>
                </Col>
            </Row>
            <Row>
                <Col md={12}>
